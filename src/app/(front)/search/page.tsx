...
import { symptomDataProps, getDoctorsBySearch } from '../../../../actions/doctors'
...
export default async function Page({ searchParams }: {searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
    ...
    return (
        <div className="container p-8">
            <h1 className="capitalize scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-4xl pb-6">{query} ({doctors.length.toString().padStart(2, "0")})</h1>
